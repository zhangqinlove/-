...
excludes = {'什么','一个','我们','你们','如今','说道','老太太','知道','姑娘','起来',
            ...
            '不敢','出去','所以','不过','不好','姐姐','的话','一时','过来','二爷',
            '这么','只管','不能','今日','二人','答应','几个','人家','还有','说话',
            '这话','自然','打发','今儿','罢了','不用','屋里','如何','那些','问道',
            '小丫头','听说','姊妹','一声','看见','回去','原来','家里','进去','孩子',
            }


txt = open('D:/117010800122/红楼梦.txt','r', encoding='GB18030').read()
...
for word in words:
    if word in includes:
        if word == '凤姐' or word == '熙凤':
            ...
            rword = '宝钗'
        elif word == '林姑娘' or word == '黛玉' or word=='林妹妹':
            rword = '黛玉'
        else:
            rword = word
